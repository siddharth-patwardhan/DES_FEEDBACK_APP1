...
import 'package:des_feedback_app/views/select_theme_dialog.dart';
  ...
  _buildBody() {
    return ListView(
      children: <Widget>[
        ...
        _menuItem(title: "Sign In", icon: MdiIcons.account, onTap: () {Navigator.push(
          context,
          MaterialPageRoute(builder: (context) {
            return RegisterScreen();
          }),
        );}),
        _menuItem(title: "Questionnaire", icon: MdiIcons.accountPlus, onTap: () {Navigator.push(
          context,
          MaterialPageRoute(builder: (context) {
            return AddQuestion();
          }),
